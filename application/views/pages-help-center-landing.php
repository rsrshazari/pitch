...
<!-- Mirrored from themeselection.com/demo/sneat-bootstrap-html-admin-template/html/vertical-menu-template/pages-help-center-landing.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Feb 2022 05:26:17 GMT -->
<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />

    <title>Help Center - Pages | Sneat - Bootstrap 5 HTML Admin Template - Pro</title>
...
<svg width="25" viewBox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
      ...
      <span class="app-brand-text demo menu-text fw-bolder ms-2">Pitch</span>
    </a>
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item">
      <a href="createpersentation.html" class="menu-link">
        <i class="menu-icon tf-icons bx bxs-file"></i>
        <div data-i18n="Create Presentation">Create Presentation</div>
      </a>
    </li>

    <li class="menu-item">
      <a href="presentationlist.html" class="menu-link">
        <i class="menu-icon tf-icons bx bx-user"></i>
        <div data-i18n="Presentation List">Presentation List</div>
      </a>
    </li>

    <li class="menu-item">
      <a href="workspace.html" class="menu-link">
        <i class="menu-icon tf-icons bx bx-user"></i>
    ...
    <li class="menu-item">
      <a href="javascript:void(0);" class="menu-link">
        ...
        <div data-i18n="Share Social Media">Share Social Media</div>
      </a>
    </li>
    ...
    <li class="menu-item">
      <a href="pages-pricing.html" class="menu-link">
        ...
        <div data-i18n="Pricing">Subscription</div>
      </a>
    </li>
            ...
            <div class="col-md-4 mb-md-0 mb-4">
              <div class="card border shadow-none">
                <div class="card-body text-center">
                  ...
                  <a class="btn btn-label-primary" href="pages-help-center-article.html">Read More</a>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 mb-4">
              <div class="card">
                <div class="card-body">
                  ...
                  <p><a href="pages-help-center-categories.html">Pricing Wizard</a></p>
                  <p class="mb-4"><a href="pages-help-center-categories.html">Square Sync</a></p>
            ...
            <div class="col-md-4 col-sm-6 mb-4">
              <div class="card">
                <div class="card-body">
                  ...
                  <p><a href="pages-help-center-categories.html">First Steps</a></p>
                  <p class="mb-4"><a href="pages-help-center-categories.html">Add Images</a></p>
                  <p class="mb-0 fw-semibold">
            ...
            <div class="col-md-4 col-sm-6 mb-4">
              <div class="card">
                <div class="card-body">
                  ...
                  <p><a href="pages-help-center-categories.html">Insights</a></p>
                  <p class="mb-4">
            ...
            <div class="col-md-4 col-sm-6 mb-4">
              <div class="card">
                <div class="card-body">
                  ...
                  <p><a href="pages-help-center-categories.html">Getting Started</a></p>
                  <p class="mb-4">
...
<!-- Mirrored from themeselection.com/demo/sneat-bootstrap-html-admin-template/html/vertical-menu-template/pages-help-center-landing.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Feb 2022 05:26:19 GMT -->
</html>
