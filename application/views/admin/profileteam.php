...
<li class="nav-item"><a class="nav-link" href="<?= base_url('Home/profile')?>"><i class='bx bx-user'></i> Profile</a></li>
...
<div class="d-flex align-items-center mb-3">
  <a href="javascript:;" class="d-flex align-items-center">
    <div class="avatar avatar-sm me-2">
      <img src="<?= base_url()?>assets/img/icons/brands/social-label.png" alt="Avatar" class="rounded-circle">
    </div>
    <div class="me-2 text-body h5 mb-0">
      Digital Marketing
    </div>
...
<div class="d-flex align-items-center mb-3">
  <a href="javascript:;" class="d-flex align-items-center">
    <div class="avatar avatar-sm me-2">
      <img src="<?= base_url()?>assets/img/icons/brands/event-label.png" alt="Avatar" class="rounded-circle">
    </div>
    <div class="me-2 text-body h5 mb-0">
      Event
    </div>
...
<div class="d-flex align-items-center mb-3">
  <a href="javascript:;" class="d-flex align-items-center">
    <div class="avatar avatar-sm me-2">
      <img src="<?= base_url()?>assets/img/icons/brands/html-label.png" alt="Avatar" class="rounded-circle">
    </div>
    <div class="me-2 text-body h5 mb-0">
      Only Beginners
    </div>
  ...
  <div class="d-flex align-items-center">
    <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
      ...
      <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Leona Miller" class="avatar avatar-sm pull-up">
        <img class="rounded-circle" src="<?= base_url()?>assets/img/avatars/20.png" alt="Avatar">
      </li>
      <li>
