...
<li class="nav-item"><a class="nav-link" href="<?= base_url('admin/accountsetting')?>"><i class="bx bx-user me-1"></i> Account</a></li>
<li class="nav-item"><a class="nav-link" href="<?= base_url('admin/accountsecurity')?>"><i class="bx bx-lock-alt me-1"></i> Security</a></li>
