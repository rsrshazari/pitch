...
<!-- Mirrored from themeselection.com/demo/sneat-bootstrap-html-admin-template/html/vertical-menu-template/pages-help-center-categories.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Feb 2022 05:26:19 GMT -->
<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />

    <title>Help Center Categories - Pages | Sneat - Bootstrap 5 HTML Admin Template - Pro</title>
    ...
    <div class="card overflow-hidden">
      <div class="card-body">
        ...
        <ul class="list-unstyled my-4">
          <li class="mb-3">
            <a href="pages-help-center-article.html" class="d-flex fw-semibold">
